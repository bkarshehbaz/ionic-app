// import { addedDiff, deletedDiff, detailedDiff, diff, updatedDiff } from "deep-diff";
...
// let d = diff(myPackage.devDependencies, theirPackage.devDependencies);
// d = filter(d, (_d) => {
//     return _d.rhs;
// });
// d = map(d, (_d) => {
//     return `${_d.path[0]}@${_d.rhs}`;
// });
